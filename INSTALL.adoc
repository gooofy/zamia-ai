...
* pkg-config, git, gcc, automake, autoconf, libtoolize, subversion 
...
apt-get install cython swig python-sqlite libatlas-dev libatlas3-base pkg-config git zlib1g-dev automake autoconf libtool subversion libpulse-dev libcurl4-openssl-dev libpcre3-dev xutils-dev dos2unix
----
...
in order to build `libxsb.so`, execute this command:
