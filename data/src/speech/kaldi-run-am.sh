...
steps/decode.sh  --iter 4 --nj $nDecodeJobs --cmd "$decode_cmd"  exp/tri3b/graph \
 data/$testDir exp/tri3b_mmi/decode_it4
steps/decode.sh  --iter 3 --nj $nDecodeJobs --cmd "$decode_cmd" exp/tri3b/graph \
 data/$testDir exp/tri3b_mmi/decode_it3 # Do the same with boosting.
...
steps/decode.sh  --iter 4 --nj $nDecodeJobs --cmd "$decode_cmd" exp/tri3b/graph \
 data/$testDir exp/tri3b_mmi_b0.05/decode_it4 || exit 1;
steps/decode.sh  --iter 3 --nj $nDecodeJobs --cmd "$decode_cmd" exp/tri3b/graph \
 data/$testDir exp/tri3b_mmi_b0.05/decode_it3 || exit 1;

# Do MPE.
steps/train_mpe.sh --cmd "$train_cmd" data/train data/lang exp/tri3b_ali exp/tri3b_denlats exp/tri3b_mpe || exit 1;

steps/decode.sh  --iter 4 --nj $nDecodeJobs --cmd "$decode_cmd" exp/tri3b/graph \
 data/$testDir exp/tri3b_mpe/decode_it4 || exit 1;

steps/decode.sh  --iter 3 --nj $nDecodeJobs --cmd "$decode_cmd" exp/tri3b/graph \
 data/$testDir exp/tri3b_mpe/decode_it3 || exit 1;
