...
_GO    = '_GO'
_EOS   = '_EOS' # also functions as PAD
_UNK   = '_UNK'
    ...
    def init_placeholders(self):       
        ...
        if self.mode == 'train':
            ...
            decoder_start_token = tf.ones(
                shape=[self.batch_size, 1], dtype=tf.int32) * GO_ID
            decoder_end_token = tf.ones(
                shape=[self.batch_size, 1], dtype=tf.int32) * EOS_ID            
    ...
    def build_decoder(self):
        ...
        with tf.variable_scope('decoder'):
            ...
            if self.mode == 'train':
                ...
                start_tokens = tf.ones([self.batch_size,], tf.int32) * GO_ID
